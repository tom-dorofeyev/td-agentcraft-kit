...
| Test coverage, acceptance scope, regression risk, reproducibility, verification gaps | **QA Engineer** | Coverage/risk assessment with referenced tests or missing cases |
